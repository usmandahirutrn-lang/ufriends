...
// Add safe payload types for tooltip and legend entries
...
// Define explicit props for tooltip content to align with Recharts
type TooltipContentProps = React.ComponentProps<"div"> & {
  active?: boolean
  payload?: TooltipEntry[]
  label?: unknown
  labelFormatter?: (label: unknown, payload: TooltipEntry[]) => React.ReactNode
  formatter?: (
    value: number,
...
function ChartTooltipContent({
  ...
  const payloadArr: TooltipEntry[] = Array.isArray(payload)
...
function ChartLegendContent({
  ...
  const payloadArr: LegendEntry[] = Array.isArray(payload)
    ? (payload as LegendEntry[])
    : []
