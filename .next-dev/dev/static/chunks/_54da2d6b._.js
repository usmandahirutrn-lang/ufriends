...
"[project]/app/services/training/premium-user/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PremiumUserTrainingPage() {
    ...
    const [deliveryOption, setDeliveryOption] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const { price: upgradePrice, isLoading: priceLoading, submitService } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDynamicPricing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("training", "premium-user", "subscription", {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PremiumUserTrainingPage.useEffect": ()=>{
            const loadData = {
                "PremiumUserTrainingPage.useEffect.loadData": async ()=>{
                    try {
                        // Check subscription status from localStorage for now
                        const subData = localStorage.getItem("ufriends_user_subscription");
                        const subscription = subData ? JSON.parse(subData) : {
                            isPremium: false
                        };
                        setIsPremium(subscription.isPremium);
                        // Load trainings from API
                        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$client$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authFetch"])("/api/training?category=Premium");
                        if (res.ok) {
            ...
            }["PremiumUserTrainingPage.useEffect.loadData"];
            loadData();
        }
    }["PremiumUserTrainingPage.useEffect"], []);
    const handleUpgrade = ()=>{
    ...
    const handlePinConfirm = async (pin)=>{
        ...
        try {
            ...
            if (!resp.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(resp.error || "Upgrade Failed");
                return;
            }
            const subscription = {
                userId: "u_001",
            ...
            setIsPremium(true);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("You now have Premium Access!");
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err.message || "An error occurred");
        } finally{
            setIsSubmitting(false);
        }
    };
    const isNewTraining = (createdAt)=>{
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        isNewTraining(training.createdAt) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
...
_s(PremiumUserTrainingPage, "vvdZxpT1Z27i6xCcu9d00fIgCbA=", false, function() {
    return [
...
_c = PremiumUserTrainingPage;
var _c;
__turbopack_context__.k.register(_c, "PremiumUserTrainingPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_54da2d6b._.js.map