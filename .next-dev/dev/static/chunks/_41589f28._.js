...
"[project]/app/admin/assets/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminAssetsPage() {
    ...
    const upload = async ()=>{
        ...
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$client$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authFetch"])(`/api/admin/assets`, {
                method: "POST",
                body: form
            });
            const json = await res.json();
...
_s(AdminAssetsPage, "2LVQPx5nL2huDhdq3VNHAugKRW8=");
_c = AdminAssetsPage;
var _c;
__turbopack_context__.k.register(_c, "AdminAssetsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_41589f28._.js.map