...
"[project]/app/services/training/bvn-modification/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BVNModificationTrainingPage() {
    ...
    const { price: upgradePrice, isLoading: priceLoading, submitService } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDynamicPricing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("training", "bvn-modification", "basic");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BVNModificationTrainingPage.useEffect": ()=>{
            setTimeout({
                "BVNModificationTrainingPage.useEffect": ()=>{
                    ...
                    const data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$training$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTrainingsByCategory"])("BVN");
                    setTrainings(data);
                    setLoading(false);
                }
            }["BVNModificationTrainingPage.useEffect"], 500);
        }
    }["BVNModificationTrainingPage.useEffect"], []);
    const handleUpgrade = ()=>{
        setPendingPayload({
...
_s(BVNModificationTrainingPage, "KTRVIiZ+vttVaEkCasNWepG7cDo=", false, function() {
    return [
...
_c = BVNModificationTrainingPage;
var _c;
__turbopack_context__.k.register(_c, "BVNModificationTrainingPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_5a5c80c6._.js.map