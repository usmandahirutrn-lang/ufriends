        ...
        "PremiumUserTrainingPage.useEffect": ()=>{
            setTimeout({
                "PremiumUserTrainingPage.useEffect": ()=>{
                    ...
                    const data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$training$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTrainings"])().filter({
                        "PremiumUserTrainingPage.useEffect.data": (t)=>t.category === "Premium"
                    }["PremiumUserTrainingPage.useEffect.data"]);
                    setTrainings(data);
                    setLoading(false);
                }
            }["PremiumUserTrainingPage.useEffect"], 500);
        }
    }["PremiumUserTrainingPage.useEffect"], []);
    const handleUpgrade = ()=>{
        setPendingPayload({
...
_s(PremiumUserTrainingPage, "P0hJV3xPdma6M9A7y1fU7BREVBU=", false, function() {
    return [
...
//# sourceMappingURL=_6cc18cdd._.js.map