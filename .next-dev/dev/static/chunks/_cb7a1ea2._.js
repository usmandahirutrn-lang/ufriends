...
function BVNPrintoutPage() {
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            if (!resp.ok) throw new Error(resp.error || "Service failed");
            ...
            console.error("BVN Printout Error:", message);
            toast({
                title: "Error",
                description: message,
                variant: "destructive"
...
_s(BVNPrintoutPage, "SR64KAH88ySUHQE5EmaYbgznZgc=", false, function() {
    return [
...
//# sourceMappingURL=_cb7a1ea2._.js.map