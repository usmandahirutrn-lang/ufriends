...
"[project]/app/api/admin/system-settings/bvn-android/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const setting = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].systemSettings.findUnique({
            where: {
                key: SETTING_KEY
            }
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(setting.valueJson);
    } catch (error) {
...
async function POST(req) {
    try {
        ...
        const updatedSetting = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].systemSettings.upsert({
            where: {
                key: SETTING_KEY
            },
            update: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedSetting.valueJson);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__12415155._.js.map