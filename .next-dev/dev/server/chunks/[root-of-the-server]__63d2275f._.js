...
"[project]/app/api/admin/pos/requests/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const all = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].posRequest.findMany({
            orderBy: {
                createdAt: "desc"
            },
            include: {
        ...
        let filtered = all.map((r)=>{
            const info = r.businessInfo || {};
            const uiStatus = r.status === "PENDING" ? "Pending" : r.status === "PROCESSING" ? "Approved" : r.status === "COMPLETED" ? "Completed" : r.status === "FAILED" ? "Rejected" : String(r.status);
            return {
                id: r.id,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Failed to list POS requests",
            detail: String(err)
        }, {
            status: 500
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__63d2275f._.js.map