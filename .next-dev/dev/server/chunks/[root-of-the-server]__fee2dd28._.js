...
"[project]/app/api/admin/services/metrics/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const rows = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].transaction.findMany({
            where: {
                createdAt: {
                    gte: since24h
                },
        ...
        for (const tx of rows){
            ...
            const subServiceId = meta.subServiceId || "unknown";
        ...
        for (const svc of Object.values(byService)){
            ;
            svc.successRate = svc.total > 0 ? Math.round(svc.success / svc.total * 100) : 0;
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            window: "24h",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fee2dd28._.js.map