...
"[project]/app/api/popup-messages/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const setting = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].systemSettings.findUnique({
            where: {
                key: POPUP_MESSAGES_KEY
            }
        });
        const messages = setting?.valueJson ? setting.valueJson : [];
        if (activeOnly) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Failed to fetch popup messages",
            detail: String(err)
        }, {
            status: 500
        });
...
async function POST(req) {
    try {
        ...
        const { action, message, id, updates } = body;
        const setting = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].systemSettings.findUnique({
            where: {
                key: POPUP_MESSAGES_KEY
            }
        });
        let messages = setting?.valueJson ? setting.valueJson : [];
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Failed to update popup messages",
            detail: String(err)
        }, {
            status: 500
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7a1cfd5a._.js.map