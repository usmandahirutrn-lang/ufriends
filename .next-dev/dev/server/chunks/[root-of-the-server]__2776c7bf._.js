...
async function GET(req) {
    try {
        ...
        const [notifications, unreadCount] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notification.findMany({
                where,
                orderBy: {
                    createdAt: "desc"
                },
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notification.count({
                where: {
                    userId: auth.user.id,
                    readAt: null
                }
...
async function POST(req) {
    try {
        ...
        if (markAllRead) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notification.updateMany({
                where: {
                    userId: auth.user.id,
                    readAt: null
                },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2776c7bf._.js.map