...
"[project]/app/api/disputes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!service || !issue) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Service and issue are required"
            }, {
                status: 400
            });
        }
        const dispute = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dispute.create({
            data: {
                userId: auth.user.id,
                service,
                issue,
        ...
        const { sendAdminNotification } = await __turbopack_context__.A("[project]/lib/notifications.ts [app-route] (ecmascript, async loader)");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8694ec10._.js.map