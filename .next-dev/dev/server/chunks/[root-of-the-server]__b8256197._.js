...
"[project]/app/api/pricing/parameters/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const rows = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].catalogPricing.findMany({
            where: {
                category: {
                    equals: category,
                    mode: __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["Prisma"].QueryMode.insensitive
                },
                OR: aliases.map((sub)=>({
                        subservice: {
                            equals: sub,
        ...
        for (const r of rows){
            ...
            for (const [k, v] of Object.entries(params)){
                if (!(k in options)) options[k] = new Set();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b8256197._.js.map