...
async function GET(req) {
    try {
        ...
        // Get system settings
        const systemSetting = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].systemSettings.findUnique({
            where: {
                key: SYSTEM_SETTINGS_KEY
            }
        });
        // Get admin notification preferences
        const notifSetting = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].systemSettings.findUnique({
            where: {
                key: ADMIN_NOTIFICATION_PREFS_KEY
            }
        });
        // Get floating action bar settings
        const floatingSetting = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].systemSettings.findUnique({
            where: {
                key: FLOATING_ACTION_SETTINGS_KEY
            }
        });
        // Get admin profile data from user
        const adminProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
            where: {
                id: auth.user.id
            },
            include: {
...
async function POST(req) {
    try {
        ...
        if (type === "floating_action") {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: true,
                message: "Floating action settings updated"
            });
        }
        if (type === "profile") {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].profile.upsert({
                where: {
                    userId: auth.user.id
                },
                update: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__92f9e0a0._.js.map