...
"[project]/app/api/auth/2fa/setup/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        if (!secret) {
            secret = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$otplib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticator"].generateSecret();
        ...
        const otpAuthUrl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$otplib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticator"].keyuri(user.email, appName, secret);
        const qrCodeDataUrl = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$qrcode$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toDataURL"](otpAuthUrl);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            enabled: false,
            secret,
...
async function POST(req) {
    try {
        ...
        if (!user.totpSecret) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "No pending 2FA setup. Generate a QR code first."
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__52ae693b._.js.map