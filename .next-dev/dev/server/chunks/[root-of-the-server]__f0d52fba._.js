...
"[project]/app/api/admin/service/logs/[reference]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, context) {
    try {
        ...
        const tx = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].transaction.findUnique({
            where: {
                reference
            }
        });
        ...
        let provider = null;
        if (providerId) {
            const p = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].serviceProvider.findUnique({
                where: {
                    id: providerId
                },
                select: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f0d52fba._.js.map