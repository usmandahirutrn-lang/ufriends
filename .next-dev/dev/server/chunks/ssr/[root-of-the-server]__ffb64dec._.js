...
function NINVerificationPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            // Use the standardized submitService which handles billing and verification
            const resp = await submitService({
                amount: amt,
                idempotencyKey: crypto.randomUUID(),
                // Pass params expected by the server handler
                nin,
                slipType
            });
            if (!resp.ok) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ffb64dec._.js.map