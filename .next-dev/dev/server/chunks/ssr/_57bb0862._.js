...
"[project]/app/admin/bvn/android-requests/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminBVNRequestsPage() {
    ...
    const loadData = async ()=>{
        setRequests(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$bvn$2d$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BVNStorage"].getRequests());
        try {
    ...
    const saveSettings = async ()=>{
        setIsSaving(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$client$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authFetch"])("/api/admin/system-settings/bvn-android", {
                method: "POST",
                headers: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$bvn$2d$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BVNStorage"].addAuditLog({
    ...
    const handleApprove = (request)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$bvn$2d$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BVNStorage"].updateRequest(request.id, {
            status: "Approved",
    ...
    const handleReject = ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$bvn$2d$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BVNStorage"].updateRequest(selectedRequest.id, {
            status: "Rejected",
            rejectionReason,
            reviewedBy: MOCK_ADMIN,
            reviewedAt: new Date().toISOString()
    ...
    const handleDelete = (request)=>{
        const allRequests = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$bvn$2d$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BVNStorage"].getRequests();
        const filtered = allRequests.filter((r)=>r.id !== request.id);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$bvn$2d$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BVNStorage"].saveRequests(filtered);
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$bvn$2d$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BVNStorage"].addAuditLog({
...
//# sourceMappingURL=_57bb0862._.js.map