...
function LoginForm() {
    ...
    const validateEmail = (v)=>{
        const schema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().toLowerCase().email({
    ...
    const validatePassword = (v)=>{
        const schema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(6, {
    ...
    const onSubmit = async (e)=>{
        ...
        if (!parsed.success) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Please provide a valid email and password (≥6 chars)");
            return;
        }
        ...
        try {
            ...
            if (check2FAData.requires2FA) {
                ...
                if (!verifyRes.ok) {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(errData.error || "Invalid email or password");
                    return;
                }
            ...
            if (res?.ok) {
                ...
                try {
                    ...
                    if (tokenRes.ok) {
                        ...
                        const refresh = data?.tokens?.refreshToken;
                        if (access && refresh) {
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$client$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveTokens"])({
                                accessToken: access,
                                refreshToken: refresh
                            });
                        }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(err.message || "Sign-in failed");
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ca3c746._.js.map