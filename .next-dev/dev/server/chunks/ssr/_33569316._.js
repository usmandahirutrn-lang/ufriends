...
"[project]/lib/client-pdf.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "downloadPdfAuto",
    ()=>downloadPdfAuto,
    "downloadPdfAutoWithData",
    ()=>downloadPdfAutoWithData,
    "downloadPdfViaServer",
    ()=>downloadPdfViaServer
]);
function getDispositionFilename(res) {
    const disp = res.headers.get("Content-Disposition") || "";
    const m = disp.match(/filename="([^"]+)"/i);
    return m?.[1];
}
async function downloadPdfViaServer(templateId, action, params, fileName, data) {
...
async function downloadPdfAuto(action, params, fileName, slipType) {
...
async function downloadPdfAutoWithData(action, data, fileName, slipType) {
    const r = await fetch("/api/templates/resolve", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
...
"[project]/app/services/bvn/printout/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$client$2d$pdf$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/client-pdf.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
;
;
function BVNPrintoutPage() {
    const [showPrivacyWarning, setShowPrivacyWarning] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const [verificationPayload, setVerificationPayload] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [slipType, setSlipType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("standard");
    ...
    const { price: servicePrice, isLoading: priceLoading, error: pricingError, submitService } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDynamicPricing$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useDynamicPricing"])("bvn", "printout", "default");
    const stringifyError = (err)=>{
        try {
            ...
            if (cause && typeof cause === "object") {
                const cmsg = cause.message || cause.detail || cause.error || cause.statusText;
    ...
    const handleSubmit = async ()=>{
        if (!bvn || bvn.length !== 11 || !agreePrivacy || !agreeTerms) {
            toast({
                ...
                description: "Enter a valid 11-digit BVN and accept privacy/terms.",
                variant: "destructive"
            });
            return;
        }
        ...
        if (!Number.isFinite(amount) || amount <= 0) {
            toast({
                ...
                description: "Service price not available.",
                variant: "destructive"
            });
            return;
        }
    ...
    const handlePinConfirm = async (pin)=>{
        ...
        try {
            ...
            if (!resp.ok) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$service$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleServiceError"])(resp, toast, "BVN Printout Failed");
                return;
            }
            ...
            toast({
                title: "Success!",
                description: "BVN printout retrieved and billed."
            });
        } catch (error) {
            toast({
                title: "Error",
    ...
    const downloadBVNPrintout = async ()=>{
        try {
            const data = verificationPayload || verificationData || {};
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$client$2d$pdf$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["downloadPdfAutoWithData"])("bvn.printout", data, "bvn-printout", slipType);
            toast({
                title: "Success",
                description: "Downloaded BVN printout"
            });
        } catch (err) {
            try {
                ...
                const doc = new (await __turbopack_context__.A("[project]/node_modules/jspdf/dist/jspdf.es.min.js [app-ssr] (ecmascript, async loader)")).default();
                doc.setFontSize(18);
                ...
                toast({
                    title: "Downloaded",
                    description: "Basic BVN printout generated"
                });
            } catch  {
                toast({
                    title: "Error",
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$triangle$2d$alert$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertTriangle$3e$__["AlertTriangle"], {
                                        ...
                                        fileName: "[project]/app/services/bvn/printout/page.tsx",
                                        lineNumber: 164,
                                        columnNumber: 15
                                    }, this)
                                }, void 0, false, {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                            ...
                            children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                    className: "flex items-center space-x-2 border p-3 rounded-md cursor-pointer hover:bg-gray-50 transition-colors w-full",
                                                    children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    disabled: isProcessing || bvn.length !== 11 || !agreePrivacy || !agreeTerms || priceLoading,
                                    className: "w-full bg-[#3457D5] py-6 text-base font-semibold text-white hover:bg-[#3457D5]/90",
                                    children: isProcessing ? "Processing..." : priceLoading ? "Loading price..." : `Submit - ₦${servicePrice ?? 0}`
                                }, void 0, false, {
                                    fileName: "[project]/app/services/bvn/printout/page.tsx",
                                    lineNumber: 253,
                                    columnNumber: 13
                                ...
                                showDownload && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                    onClick: downloadBVNPrintout,
                                    className: "w-full bg-green-600 py-6 text-base font-semibold text-white hover:bg-green-700",
                                    children: "Download BVN Printout (PDF)"
                                }, void 0, false, {
                                    fileName: "[project]/app/services/bvn/printout/page.tsx",
                                    lineNumber: 257,
                                    columnNumber: 15
                                }, this),
                                pricingError ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-sm text-red-600 mt-2",
                                    children: String(pricingError)
                                }, void 0, false, {
                                    fileName: "[project]/app/services/bvn/printout/page.tsx",
                                    lineNumber: 262,
                                    columnNumber: 15
...
//# sourceMappingURL=_33569316._.js.map