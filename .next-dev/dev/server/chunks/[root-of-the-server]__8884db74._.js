...
async function POST(req) {
    ...
    try {
        ...
        if (parsed.success && parsed.data.refreshToken) {
            try {
                const payload = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyRefreshToken"])(parsed.data.refreshToken);
                const jti = payload.jti;
                const userId = payload.sub;
                if (jti && userId) {
                    const record = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].refreshToken.findUnique({
                        where: {
                            tokenId: jti
                        }
                    });
                    if (record && record.userId === userId && !record.revokedAt) {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].refreshToken.update({
                            where: {
                                tokenId: jti
                            },
                            data: {
    ...
    res.cookies.set("__Secure-next-auth.csrf-token", "", {
        path: "/",
        maxAge: 0,
        secure: true
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8884db74._.js.map