...
async function GET(req) {
    try {
        ...
        const trainings = setting?.valueJson ? setting.valueJson : [];
        if (category) {
...
async function POST(req) {
    try {
        ...
        const { action, training, id, updates } = body;
        const setting = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].systemSettings.findUnique({
            where: {
                key: TRAININGS_KEY
            }
        });
        let trainings = setting?.valueJson ? setting.valueJson : [];
        if (action === "create" && training) {
            ...
            trainings = trainings.map((t)=>t.id === id ? {
                    ...t,
                    ...updates
                } : t);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Failed to update trainings",
            detail: String(err)
        }, {
            status: 500
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3e471d98._.js.map