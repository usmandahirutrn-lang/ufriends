...
export default function BVNModificationTrainingPage() {
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      const data = getTrainingsByCategory("BVN")
      setTrainings(data)
      setLoading(false)
    }, 500)
  }, [])
        ...
        >
          <Card className="text-center p-10 rounded-2xl shadow-lg max-w-md">
            ...
            <p className="text-sm text-gray-600 mb-6">
              Upgrade to access BVN modification training with update guides, error handling tips, and compliance
              information.
            </p>
      ...
      <div className="max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-4xl font-bold text-[#3457D5]">BVN Modification Training</h1>
            <Badge className="bg-gradient-to-r from-[#3457D5] to-[#CCCCFF] text-white">Premium</Badge>
          </div>
          <p className="text-gray-600 mb-8">
            Learn BVN update procedures, error handling tips, and regulatory compliance requirements.
          </p>
        </motion.div>
        ...
        {trainings.length === 0 ? (
          <Card className="p-12 text-center rounded-2xl shadow-sm">
            ...
            <p className="text-gray-600">Check back later for BVN modification tutorials.</p>
          </Card>
        ) : (
