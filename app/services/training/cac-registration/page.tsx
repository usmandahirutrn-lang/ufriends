...
export default function CACRegistrationTrainingPage() {
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      const data = getTrainingsByCategory("CAC")
      setTrainings(data)
      setLoading(false)
    }, 500)
  }, [])
        ...
        >
          <Card className="text-center p-10 rounded-2xl shadow-lg max-w-md">
            ...
            <p className="text-sm text-gray-600 mb-6">
              Upgrade to access CAC registration training with step-by-step guides and downloadable templates.
            </p>
      ...
      <div className="max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-4xl font-bold text-[#3457D5]">CAC Registration Training</h1>
            <Badge className="bg-gradient-to-r from-[#3457D5] to-[#CCCCFF] text-white">Premium</Badge>
          </div>
          <p className="text-gray-600 mb-8">
            Learn how to register a company with the Corporate Affairs Commission (CAC) with our comprehensive
        ...
        {trainings.length === 0 ? (
          <Card className="p-12 text-center rounded-2xl shadow-sm">
            ...
            <p className="text-gray-600">Check back later for CAC registration tutorials.</p>
          </Card>
        ) : (
