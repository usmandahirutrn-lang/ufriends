...
export default function NECOPage() {
  ...
  const handlePinConfirm = async (pin: string) => {
    ...
    try {
      ...
      toast({ title: "NECO Pin Purchase Failed", description: errorMessage, variant: "destructive" })
    } finally {
      setIsSubmitting(false)
    }
  }
        ...
        >
          <Card className="border-[#3457D5]">
            ...
            <CardContent className="pt-6 space-y-4">
              <p className="text-lg">Your NECO Pin(s) have been generated successfully.</p>
    ...
    <div className="min-h-screen bg-[#F9F7F3] p-6">
      <div className="max-w-6xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <h1 className="text-4xl font-bold text-[#3457D5] mb-2">NECO Services</h1>
          <p className="text-gray-600">Purchase NECO examination pins and scratch cards</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Select value={serviceType} onValueChange={setServiceType} required>
                      ...
                      <SelectContent>
                        <SelectItem value="NECO Pin">NECO Pin / Scratch Card</SelectItem>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
            <Card className="bg-gradient-to-br from-[#3457D5]/10 to-[#CCCCFF]/20">
              <CardHeader>
                <CardTitle className="text-[#3457D5]">About NECO Services</CardTitle>
              </CardHeader>
