...
export default function NABTEBPage() {
  ...
  const handlePinConfirm = async (pin: string) => {
    ...
    try {
      ...
      setReferenceId(resp.reference || `NABTEB-${Date.now()}`)
      setShowSuccess(true)
      toast({
        title: "Success!",
        description: `Your NABTEB Pin(s) have been generated successfully${resp.reference ? ` with reference: ${resp.reference}` : ''}.`,
      })
    } catch (error: any) {
      const errorMessage = error?.message || error?.error || "Failed to process request. Please try again."
      toast({ title: "NABTEB Pin Purchase Failed", description: errorMessage, variant: "destructive" })
    } finally {
      setIsSubmitting(false)
    }
  }
  ...
  const generatePDF = () => {
    ...
    doc.save("NABTEB_Pin_Receipt.pdf")
  }
        ...
        >
          <Card className="border-[#3457D5]">
            ...
            <CardContent className="pt-6 space-y-4">
              <p className="text-lg">Your NABTEB Pin(s) have been generated successfully.</p>
    ...
    <div className="min-h-screen bg-[#F9F7F3] p-6">
      <div className="max-w-6xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <h1 className="text-4xl font-bold text-[#3457D5] mb-2">NABTEB Services</h1>
          <p className="text-gray-600">Purchase NABTEB examination pins and scratch cards</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Select value={serviceType} onValueChange={setServiceType} required>
                      ...
                      <SelectContent>
                        <SelectItem value="NABTEB Pin">NABTEB Pin / Scratch Card</SelectItem>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
            <Card className="bg-gradient-to-br from-[#3457D5]/10 to-[#CCCCFF]/20">
              <CardHeader>
                <CardTitle className="text-[#3457D5]">About NABTEB Services</CardTitle>
              </CardHeader>
